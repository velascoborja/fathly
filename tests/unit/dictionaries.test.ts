...
describe("dictionaries", () => {
  it("uses expenses nomenclature for budget commitments", () => {
    ...
    expect(dictionaries.es.dashboard.monthlyResultSurplus).toBe("Libre tras gastos y ahorro")
    ...
    expect(dictionaries.en.dashboard.monthlyResultSurplus).toBe("Left after expenses and savings")
