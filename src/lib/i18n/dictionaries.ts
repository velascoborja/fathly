...
export const dictionaries = {
  es: {
    ...
    dashboard: {
      ...
      commandBody: "Añade datos sin salir del panel. Al guardar, los totales y gráficos se actualizan aquí mismo.",
  ...
  en: {
    ...
    dashboard: {
      ...
      commandBody: "Add data without leaving the dashboard. After save, totals and charts update here.",
